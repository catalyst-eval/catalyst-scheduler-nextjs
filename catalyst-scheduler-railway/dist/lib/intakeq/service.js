...
class IntakeQService {
     ...
     */
    getAppointments(startDate_1, endDate_1) {
        return __awaiter(this, arguments, void 0, function* (startDate, endDate, status = 'Confirmed,WaitingConfirmation,Pending') {
            try {
                ...
                while (attempt < this.MAX_RETRIES) {
                    try {
                        ...
                        if (response.status === 200)
                            break;
                        const errorText = yield response.statusText;
    ...
    getAppointment(appointmentId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield axios_1.default.get(`${this.baseUrl}/appointments/${appointmentId}`, {
                    headers: {
                        'X-Auth-Key': this.apiKey,
                        'Accept': 'application/json'
                    }
    ...
    getPractitioners() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios_1.default.get(`${this.baseUrl}/practitioners`, {
                    headers: {
                        'X-Auth-Key': this.apiKey,
                        'Accept': 'application/json'
                    }
    ...
    getClient(clientId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield axios_1.default.get(`${this.baseUrl}/clients/${clientId}`, {
                    headers: {
                        'X-Auth-Key': this.apiKey,
                        'Accept': 'application/json'
                    }
     ...
     */
    getStandardizedOfficeId(appointment) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            try {
                ...
                if ((_a = clinician === null || clinician === void 0 ? void 0 : clinician.preferredOffices) === null || _a === void 0 ? void 0 : _a.length) {
