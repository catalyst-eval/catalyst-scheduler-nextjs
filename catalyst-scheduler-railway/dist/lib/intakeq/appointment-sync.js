...
class AppointmentSyncHandler {
     ...
     */
    async processAppointmentEvent(payload) {
    ...
    async handleNewAppointment(appointment) {
        try {
    ...
    async handleAppointmentUpdate(appointment) {
        try {
     ...
     */
    async convertToAppointmentRecord(appointment) {
        try {
     ...
     */
    async determineRequirements(appointment) {
     ...
     */
    async determineOfficeAssignment(appointment) {
        try {
            // Get all offices
